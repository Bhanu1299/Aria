...
def load_scenes(path: str = "scenes.json") -> None:
    ...
    if not scene_path.is_absolute():
        scene_path = _aria_paths.ROOT / path
    try:
...
def _run_briefing() -> None:
    try:
        import aria.features.briefing as _briefing
        import aria.voice.speaker as _speaker_mod
...
def _run_job_alerts() -> None:
    try:
        import aria.features.jobs as _jobs
        import aria.state.memory as _memory
        import aria.voice.speaker as _speaker_mod
