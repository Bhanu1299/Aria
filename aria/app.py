...
for _noisy_logger in [
    ...
    "aria.web.browser", "aria.web.agent_browser",
    "aria.features.jobs", "aria.features.briefing", "aria.state.memory",
    "aria.skills.skill_loader",
    "aria.ui.menubar",
    "urllib3",
    "playwright",
    "asyncio",
    "aria.features.scene_executor",
]:
...
from aria.voice.speaker import Speaker, ThinkingAck
from aria.web.browser import BrowserExecutor
from aria.ui.menubar import AriaMenuBar
from aria.voice.hotkey import HotkeyListener
from aria.voice.wake_word import WakeWordListener
import aria.state.memory as memory
import aria.web.agent_browser as agent_browser
...
from aria.system.sleep_guard import SleepGuard
from aria.core.tool import ToolRegistry
from aria.core.agent import Agent
from aria.core.plugin import PluginContext
import aria.plugins as plugin_packs
...
def _vision_fallback(url: str, query: str) -> str:
    ...
    import aria.web.vision as _vision  # noqa: PLC0415 — intentional lazy import
...
def _handle_login() -> None:
    ...
    from aria.web.browser_profile import login_session
    login_session(url)
    sys.exit(0)


def cli() -> None:
    """Entry point used by the root main.py shim and `python -m aria.app`."""
